...
export const MOCK_VIDEOS: VideoItem[] = [
  { id: '1', title: 'Advanced Calculus: Limits and Continuity', thumbnail: 'https://images.unsplash.com/photo-1635070041078-e363dbe005cb?auto=format&fit=crop&q=80&w=600', creator: 'Prof. Ahmed', views: '12K', duration: '45:20', category: 'Education' },
  { id: '2', title: 'The Quantum World Explained', thumbnail: 'https://images.unsplash.com/photo-1636466497217-26a8cbeaf0aa?auto=format&fit=crop&q=80&w=600', creator: 'Science Hub', views: '105K', duration: '18:15', category: 'Science' },
  ...
  { id: '6', title: 'Introduction to Organic Chemistry', thumbnail: 'https://images.unsplash.com/photo-1603126859738-4e897a480520?auto=format&fit=crop&q=80&w=600', creator: 'EduMaster', views: '8K', duration: '25:10', category: 'Education' },
];
